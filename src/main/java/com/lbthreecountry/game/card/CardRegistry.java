...
public class CardRegistry {
    ...
    private void registerStrategyCards() {
        ...
        register(CardDef.builder()
                .id("shunshou")
                .type("STRATEGY").subType("SHUNSHOU")
                .rules(CardRules.builder()
                        .targetCount(1)
                        .targetType("ENEMY")
                        .rangeLimit(1)
        ...
        register(CardDef.builder()
                .id("wuxie")
                .type("STRATEGY").subType("WUXIE")
                .rules(CardRules.builder()
                        .playablePhase("RESPOND")
                        .canRespondTo(List.of("STRATEGY"))
                        .build())
                .build());
    ...
    private void registerEquipmentCards() {
        ...
        register(CardDef.builder()
                .id("zhangba")
                .type("EQUIPMENT").subType("ZHANGBA")
                .rules(CardRules.builder()
                        .equipSlot("WEAPON")
                        .attackRange(3)
                        .targetCount(0)
        ...
        register(CardDef.builder()
                .id("fangtian")
                .type("EQUIPMENT").subType("FANGTIAN")
                .rules(CardRules.builder()
                        .equipSlot("WEAPON")
                        .attackRange(4)
                        .targetCount(0)
        ...
        register(CardDef.builder()
                .id("renwang")
                .type("EQUIPMENT").subType("RENWANG")
                .rules(CardRules.builder()
                        .equipSlot("ARMOR")
                        .targetCount(0)
                        .build())
